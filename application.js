...
function renderStoreDetails(container, template, collection, slug){
    ...
    $.each( item_list , function( key, val ) {
        if ((val.store_front_url).indexOf('missing.png') > -1){
            val.alt_store_front_url = "//codecloud.cdn.speedyrails.net/sites/58752dc16e6f643bb4000000/image/png/1497619091000/logo.png";
        } else {
            val.alt_store_front_url = getImageURL(val.store_front_url); 
        }
...
function renderPosts(container, template, collection){
    ...
    $.each( collection , function( key, val ) {
        if (val.image_url.indexOf('missing.png') > -1) {
            val.image_url = "//codecloud.cdn.speedyrails.net/sites/58752dc16e6f643bb4000000/image/png/1497619091000/logo.png";
        } else {
    ...
    $(trigger).bind("change", function(e) {
        ...
        $(map).smoothZoom('addLandmark', 
			...
			'<div class="item mark" data-show-at-zoom="0" data-position="' + x_coord + ',' + y_coord + '">\
				...
				<img src="//codecloud.cdn.speedyrails.net/sites/58752dc16e6f643bb4000000/image/png/1497039299000/map_marker.png" width="45px" height="59px" alt="marker" />\
				</div>\
			</div>'
			]
		);
